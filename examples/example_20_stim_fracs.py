# ****************************************************************************
#### 20+ stim fracs, no nat fracs, w/ scaled flow
# ****************************************************************************
...
for i in range(0, 1):
    ...
    geom.rock.w_intervals = 21 # int(np.random.uniform(1, 3))  # 3 #breaks in well length
    ...
    for r in rates:
        ...
        x = base.save(build_path('inputs_results_20_stim_fracs.txt'), pin)
